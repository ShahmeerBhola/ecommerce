...
<div class="wt-pdfpro-sidebar wf_gopro_block" style="margin-bottom: 1em;">
  <div class="wt-pdfpro-header">
    <h2 style="text-align: center;"><?php _e('Watch setup video (premium)','print-invoices-packing-slip-labels-for-woocommerce');?></h2>
    <iframe src="//www.youtube.com/embed/jx_ADq_mdgM" allowfullscreen="allowfullscreen" frameborder="0" align="middle" style="width:100%;margin-bottom: 1em;"></iframe>
    </div>
  </div>
