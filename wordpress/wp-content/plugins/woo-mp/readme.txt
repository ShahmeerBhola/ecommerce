...
You can find standard instructions for installing a plugin [here](https://wordpress.org/support/article/managing-plugins/#installing-plugins). Once that's done, you can move on to the **Configuration** section below.
