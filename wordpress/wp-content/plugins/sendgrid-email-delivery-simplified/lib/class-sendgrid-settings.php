...
class Sendgrid_Settings {
  ...
  public static function set_up_menu()
  {
    ...
    // TODO: this is a quick and dirty hack to remove a deprecation warning that was showing up in wp-admin dashboard
    // See here for more information https://wordpress.org/support/topic/plugin-uses-depricated-function/
