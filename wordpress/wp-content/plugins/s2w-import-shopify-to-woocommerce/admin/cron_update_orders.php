...
if ( ! class_exists( 'S2W_IMPORT_SHOPIFY_TO_WOOCOMMERCE_ADMIN_Cron_Update_Orders' ) ) {
	class S2W_IMPORT_SHOPIFY_TO_WOOCOMMERCE_ADMIN_Cron_Update_Orders {
		...
		public function admin_menu() {
			add_submenu_page( 's2w-import-shopify-to-woocommerce', esc_html__( 'Cron Update Orders', 's2w-import-shopify-to-woocommerce' ), esc_html__( 'Cron Update Orders', 's2w-import-shopify-to-woocommerce' ), 'manage_options', 's2w-import-shopify-to-woocommerce-cron-update-orders', array(
				$this,
				'page_callback'
			) );
		}
