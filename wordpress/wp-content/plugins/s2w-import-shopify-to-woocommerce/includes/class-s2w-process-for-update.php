...
class WP_S2W_IMPORT_SHOPIFY_TO_WOOCOMMERCE_Process_For_Update extends WP_Background_Process {
	...
	protected function complete() {
		if ( ! $this->is_process_running() && $this->is_queue_empty() ) {
			set_transient( 's2w_background_processing_complete_for_update', time() );
		}
	 ...
	 * Delete all batches.
	 *
	 * @return WP_S2W_IMPORT_SHOPIFY_TO_WOOCOMMERCE_Process_For_Update
	 */
